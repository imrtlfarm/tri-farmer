...
contract ReaperStrategySpookySD is ReaperBaseStrategyv1_1 {
     ...
     * {booToSdPath} - to swap {BOO} to {USDC} (using SPOOKY_ROUTER)
     */
    address[] public booToWftmPath;
    address[] public booToUsdcPath;
    address[] public booToSdPath;
     ...
     *      2. Uses totalFee% of {BOO} to swap to {WFTM} and charge fees.
    ...
    function _addLiquidity() internal {
        ...
        _swap(booHalf, booToUsdcPath);
        _swap(IERC20Upgradeable(BOO).balanceOf(address(this)), booToSdPath);
        ...
        IUniswapV2Router02(SPOOKY_ROUTER).addLiquidity(USDC, SD, usdcBal, sdBal, 0, 0, address(this), block.timestamp);
    }
